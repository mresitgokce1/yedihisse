...
namespace yedihisse.Business.Abstract
{
    public interface IUserTypeService
    {
        ...
        Task<IDataResult<UserTypeListDto>> GetAllByNonDeletedAsync();
        Task<IDataResult<UserTypeListDto>> GetAllByNonDeletedAndActiveAsync();
        Task<IDataResult<UserTypeDto>> AddAsync(UserTypeAddDto userTypeAddDto, int createdByUserId);
        Task<IDataResult<UserTypeUpdateDto>> GetUserTypeUpdateDtoAsync(int userTypeId);
