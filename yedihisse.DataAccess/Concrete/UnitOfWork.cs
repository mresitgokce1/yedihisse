...
namespace yedihisse.DataAccess.Concrete
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private EfShippingManagerRepository _shippingManagerRepository;
        private EfShippingRepository _shippingRepository;
        ...
        public IApplicationStatusTypeRepository ApplicationStatusTypes => 
            _applicationStatusTypeRepository ?? new EfApplicationStatusTypeRepository(_context);
        ...
        public IShippingManagerRepository ShippingManagers => _shippingManagerRepository ?? new EfShippingManagerRepository(_context);
        public IShippingRepository Shippings => _shippingRepository ?? new EfShippingRepository(_context);
        public ISlaughterhouseJoinAnimalRepository SlaughterhouseJoinAnimals => 
            _slaughterhouseJoinAnimalRepository ?? new EfSlaughterhouseJoinAnimalRepository(_context);
        public ISlaughterhouseJoinTypeRepository SlaughterhouseJoinTypes =>
            _slaughterhouseJoinTypeRepository ?? new EfSlaughterhouseJoinTypeRepository(_context);
        public ISlaughterhouseManagerRepository SlaughterhouseManagers => 
            _slaughterhouseManagerRepository ?? new EfSlaughterhouseManagerRepository(_context);
