...
{
    public class EfAddressTypeRepository : EfEntityRepositoryBase<AddressType>, IAddressTypeRepository
    {
        public EfAddressTypeRepository(DbContext context) : base(context)
        {
        }
    }
}
