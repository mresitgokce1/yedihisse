...
{
    public class EfFirmManagerRepository : EfEntityRepositoryBase<FirmManager>, IFirmManagerRepository
    {
        public EfFirmManagerRepository(DbContext context) : base(context)
        {
        }
    }
}
