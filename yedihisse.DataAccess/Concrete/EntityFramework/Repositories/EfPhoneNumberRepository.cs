...
{
    public class EfPhoneNumberRepository : EfEntityRepositoryBase<PhoneNumber>, IPhoneNumberRepository
    {
        public EfPhoneNumberRepository(DbContext context) : base(context)
        {
        }
    }
}
