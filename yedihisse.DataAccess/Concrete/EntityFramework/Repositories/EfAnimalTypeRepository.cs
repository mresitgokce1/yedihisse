...
{
    public class EfAnimalTypeRepository : EfEntityRepositoryBase<AnimalType>, IAnimalTypeRepository
    {
        public EfAnimalTypeRepository(DbContext context) : base(context)
        {
        }
    }
}
